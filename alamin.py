...
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : ATIK  71
\033[1;32m  GITHUB    : atik-lx
\033[1;32m  FACEBOOK  : ATIK
\033[1;32m  TOOL NAME : FILE CLONE &&RANDOM
\033[1;32m  TOOL TYPE : PAID
\033[1;32m  VERSION   : 7.2.8
\033[1;32m---------------------------------------------------------
"""  )
...
def rcerek(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
        ...
        sys.stdout.write('\r%s[ATIK-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801608032030?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20AlAmin%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
